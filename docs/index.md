...
<div class="landing-hero">
  <div class="landing-hero__eyebrow">CODex Skills for Finance Workflows</div>
...
<div class="landing-grid">
  <div class="landing-card">
    <h2>Start fast</h2>
    <p>Use the quickstart layer for prompts like <code>跑 DCF</code>, <code>做个三张表</code>, or <code>出个投委会 memo</code>.</p>
  </div>
  <div class="landing-card">
    <h2>Route correctly</h2>
    <p>Move into the full suite when you need one of the 12 supported modeling, valuation, or decision-support workflows.</p>
  </div>
  <div class="landing-card">
    <h2>Deliver better</h2>
    <p>Generate assumption-aware Chinese outputs that feel closer to working finance materials than a generic assistant answer.</p>
  </div>
</div>
...
<div class="landing-cta">
  <div>
    ...
    <p>Install both skills, start with a quick ask, and then move into the full suite when you need a more formal output.</p>
  </div>
